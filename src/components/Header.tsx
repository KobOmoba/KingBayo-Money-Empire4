        ...
        <div className="flex items-center justify-between gap-1 md:gap-2">
          <div className="flex items-center gap-1 md:gap-3 min-w-0">
            <div className="relative flex-shrink-0">
              <Crown className="w-5 md:w-8 h-5 md:h-8 text-emerald-400" />
              <Zap className="w-2 md:w-4 h-2 md:h-4 text-amber-400 absolute -top-1 -right-1" />
            </div>
            <div className="min-w-0">
              <h1 className="text-sm md:text-xl font-bold text-white whitespace-nowrap truncate">
                KingBayo
              </h1>
          ...
          <div className="flex items-center gap-1 md:gap-4 flex-shrink-0">
            <div className="hidden sm:flex items-center gap-1 bg-slate-800/50 px-1.5 py-0.5 md:px-2 md:py-1 rounded-full">
            ...
            <button
              ...
              className="p-1 md:p-2 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors flex-shrink-0"
            >
              {darkMode ? (
                <span className="text-amber-400 text-xs md:text-base">☀️</span>
              ) : (
                <span className="text-slate-300 text-xs md:text-base">🌙</span>
              )}
            </button>
          </div>
        </div>
